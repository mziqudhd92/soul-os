"""Generate SoulOS architecture reference (static, no stale OCEAN embeds)."""

DOC_CONTENT = """# SoulOS: Architecture & Technical Reference
...
out_path = ROOT / "docs" / "reference" / "architecture.md"
out_path.write_text(DOC_CONTENT)

...
_CODE_TITLES: dict[str, str] = {
    ...
    TURN_CONTRACT_VIOLATION: "Turn contract violation",
    TURN_REJECT_TOKEN: "Reject token detected",
    TURN_STEP_MISMATCH: "Turn step mismatch",
    TURN_STATE_STALE: "Turn state stale",
    TURN_SESSION_EXPIRED: "Turn session expired",
}
